...
async def _prepare_subnet(manager: LocalChainManager, subnet_config: SubnetConfig) -> None:
    ...
    if subnet_config.create_evm_key_associations:
        # FIXME utworzyć więcej asocjacji
        #       UWAGA: utworzenie historii wymaga czekania ileś bloków bo można tworzyć tylko bieżące dane!
        # FIXME opisać te asocjacje w README localchain
