...
class DevEvmWallet(enum.Enum):
    ...
    # FIXME przynajmniej dla jednego konta dodać alternatywny portfel np. ALICE_ALT
    # FIXME zostawić tylko portfele które zostaną użyte
    ...
    def evm_address(self) -> EvmAddress:
        return EvmAddress(self.wallet.address)
