...
async def test_get_own_certificate_identity_success(
    ...
    async with sn1_mock_bt_client.mock_behavior(
        ...
        response = await test_client.get("/api/_unstable/identity/sn1/subnet/1/block/latest/certificates/self")
...
async def test_get_own_certificate_identity_not_found(
    ...
    async with sn2_mock_bt_client.mock_behavior(
        ...
        response = await test_client.get("/api/_unstable/identity/sn2/subnet/2/block/latest/certificates/self")
...
@pytest.mark.asyncio
async def test_unstable_identity_get_own_certificate_unknown_identity_returns_404(test_client, snapshot_json):
    response = await test_client.get("/api/_unstable/identity/unknown/subnet/1/block/latest/certificates/self")
