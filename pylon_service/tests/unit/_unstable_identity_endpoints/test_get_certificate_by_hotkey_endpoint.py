...
@pytest.mark.asyncio
async def test_get_certificate_identity_success(
    ...
    async with sn1_mock_bt_client.mock_behavior(
        ...
        response = await test_client.get(f"/api/_unstable/identity/sn1/subnet/1/block/latest/certificates/{hotkey}")
...
async def test_get_certificate_identity_not_found(
    ...
    async with sn2_mock_bt_client.mock_behavior(
        ...
        response = await test_client.get(f"/api/_unstable/identity/sn2/subnet/2/block/latest/certificates/{hotkey}")
