...
class TestSyncOpenAccessGetCommitment(OpenAccessEndpointTest):
    ...
    def make_endpoint_call(self, client):
        return client.open_access.get_commitment(netuid=NetUid(1), hotkey=Hotkey("hotkey1"))
    ...
    def test_success_with_none_commitment(self, pylon_client, service_mock, route_mock):
        ...
        with pylon_client:
            response = pylon_client.open_access.get_commitment(netuid=NetUid(1), hotkey=Hotkey("hotkey1"))
