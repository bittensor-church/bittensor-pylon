...
class TestSyncIdentityGetLatestEvmAssociations(IdentityEndpointTest):
    ...
    def make_endpoint_call(self, client):
        return client.unstable.identity.get_latest_evm_associations()
    ...
    def test_success_with_no_evm_associations(self, pylon_client, service_mock, route_mock, block):
        ...
        with pylon_client:
            response = pylon_client.unstable.identity.get_latest_evm_associations()
