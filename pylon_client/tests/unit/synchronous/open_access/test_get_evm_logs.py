...
class TestSyncOpenAccessGetEvmLogs(OpenAccessEndpointTest):
    ...
    def test_success_with_empty_logs(self, pylon_client, service_mock, route_mock):
        ...
        with pylon_client:
            response = pylon_client.unstable.open_access.get_evm_logs(
                contract_address=_CONTRACT_ADDRESS,
                from_block=_FROM_BLOCK,
                to_block=_TO_BLOCK,
                abi=_ABI,
