...
class TestSyncOpenAccessGetRevealedCommitments(OpenAccessEndpointTest):
    ...
    def make_endpoint_call(self, client):
        return client.unstable.open_access.get_revealed_commitments(netuid=NetUid(1), hotkey=Hotkey("hotkey1"))
