...
class TestAsyncIdentityGetCommitmentsV1(IdentityEndpointTest):
    ...
    async def make_endpoint_call(self, client):
        return await client.v1.identity.get_commitments()
    ...
    async def test_success_with_empty_commitments(self, pylon_client, service_mock, route_mock, block):
        ...
        async with pylon_client:
            response = await pylon_client.v1.identity.get_commitments()
