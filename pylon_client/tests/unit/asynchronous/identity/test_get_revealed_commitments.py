...
class TestAsyncIdentityGetRevealedCommitments(IdentityEndpointTest):
    ...
    async def make_endpoint_call(self, client):
        return await client.unstable.identity.get_revealed_commitments(hotkey=Hotkey("hotkey1"))
