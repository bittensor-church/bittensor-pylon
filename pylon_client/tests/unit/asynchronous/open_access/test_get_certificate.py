...
class TestAsyncOpenAccessGetCertificate(OpenAccessEndpointTest):
    ...
    async def make_endpoint_call(self, client):
        return await client.unstable.open_access.get_certificate(netuid=NetUid(1), hotkey=Hotkey("hotkey1"))
