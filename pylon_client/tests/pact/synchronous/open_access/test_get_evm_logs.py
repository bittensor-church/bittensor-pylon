...
def test_get_evm_logs_returns_logs(pact: Pact, get_evm_logs_response_matcher: dict, pylon_client_factory):
    (
...
def test_get_evm_logs_returns_empty_logs(pact: Pact, get_evm_empty_logs_response_matcher: dict, pylon_client_factory):
    (
