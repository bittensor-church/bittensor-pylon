...
def test_get_certificate_success(pact: Pact, get_certificate_response_matcher: dict, pylon_client_factory):
    (
    ...
    with pact.serve() as srv:
        ...
        with client:
            response = client.unstable.open_access.get_certificate(netuid=NetUid(NETUID), hotkey=Hotkey(HOTKEY_1))
