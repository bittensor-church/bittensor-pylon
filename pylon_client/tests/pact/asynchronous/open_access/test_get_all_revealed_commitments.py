...
async def test_get_all_revealed_commitments_success(
    ...
    (
        ...
        .with_request("GET", f"/api/_unstable/subnet/{NETUID}/block/latest/commitments/revealed")
    ...
    with pact.serve() as srv:
        ...
        async with client:
            response = await client.unstable.open_access.get_all_revealed_commitments(netuid=NetUid(NETUID))
