...
@pytest.mark.asyncio
async def test_get_weights_status_success(pact: Pact, get_weights_status_response_fixture: dict, pylon_client_factory):
    mechanism_id = 1
    block_number = 123
    (
    ...
    with pact.serve() as srv:
        ...
        async with client:
            response = await client.unstable.identity.get_weights_status(
