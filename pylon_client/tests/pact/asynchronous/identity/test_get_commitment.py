...
async def test_get_commitment_success(pact: Pact, get_commitment_response_matcher: dict, pylon_client_factory):
    (
        ...
        .with_request("GET", f"/api/v1/identity/{IDENTITY_NAME}/subnet/{NETUID}/block/latest/commitments/{HOTKEY_1}")
    ...
    with pact.serve() as srv:
        ...
        async with client:
            response = await client.v1.identity.get_commitment(hotkey=Hotkey(HOTKEY_1))
