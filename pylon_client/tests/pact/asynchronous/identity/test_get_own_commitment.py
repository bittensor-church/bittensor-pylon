...
async def test_get_own_commitment_success(pact: Pact, get_commitment_response_matcher: dict, pylon_client_factory):
    (
        ...
        .with_request("GET", f"/api/_unstable/identity/{IDENTITY_NAME}/subnet/{NETUID}/block/latest/commitments/self")
    ...
    with pact.serve() as srv:
        ...
        async with client:
            response = await client.unstable.identity.get_own_commitment()
