...
from tests.pact.constants import COMMITMENT_HEX, IDENTITY_NAME, IDENTITY_TOKEN, NETUID


@pytest.mark.asyncio
async def test_set_commitment_success(pact: Pact, post_commitment_response_matcher: dict, pylon_client_factory):
    (
    ...
    with pact.serve() as srv:
        ...
        async with client:
            response = await client.unstable.identity.set_commitment(commitment=CommitmentDataHex(COMMITMENT_HEX))
