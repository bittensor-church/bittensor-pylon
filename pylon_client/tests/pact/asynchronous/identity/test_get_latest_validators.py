...
from tests.pact.constants import HOTKEY_1, IDENTITY_NAME, IDENTITY_TOKEN, NETUID
...
async def test_get_latest_validators_success(pact: Pact, get_validators_response_matcher: dict, pylon_client_factory):
    (
        ...
        .with_request("GET", f"/api/_unstable/identity/{IDENTITY_NAME}/subnet/{NETUID}/block/latest/validators")
    ...
    with pact.serve() as srv:
        ...
        async with client:
            response = await client.unstable.identity.get_latest_validators()
