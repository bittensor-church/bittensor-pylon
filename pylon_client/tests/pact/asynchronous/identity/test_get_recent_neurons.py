...
@pytest.mark.asyncio
async def test_get_recent_neurons_success(pact: Pact, get_neurons_response_matcher: dict, pylon_client_factory):
    (
        ...
        .with_request("GET", f"/api/_unstable/identity/{IDENTITY_NAME}/subnet/{NETUID}/block/recent/neurons")
    ...
    with pact.serve() as srv:
        ...
        async with client:
            response = await client.unstable.identity.get_recent_neurons()
