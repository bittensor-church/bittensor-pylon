...
class AsyncOpenAccessApi(UnstableAsyncOpenAccessApi):
    ...
    async def get_commitments(self, netuid: NetUid) -> GetCommitmentsResponse:  # type: ignore[reportIncompatibleMethodOverride]
        """
    ...
    async def get_commitment(self, netuid: NetUid, hotkey: Hotkey) -> GetCommitmentResponse:  # type: ignore[reportIncompatibleMethodOverride]
        """
    ...
    async def _get_commitment_request(self, netuid: NetUid, hotkey: Hotkey) -> GetCommitmentRequest:  # type: ignore[reportIncompatibleMethodOverride]
...
class AsyncIdentityApi(UnstableAsyncIdentityApi):
    ...
    async def put_weights(self, weights: dict[Hotkey, Weight]) -> SetWeightsResponse:  # type: ignore[reportIncompatibleMethodOverride]
        """
    ...
    async def get_commitments(self) -> GetCommitmentsResponse:  # type: ignore[reportIncompatibleMethodOverride]
        """
        Retrieves all hex data commitments for the authenticated identity's subnet at the latest available block.
        Does not include timelock encrypted commitments.
    ...
    async def get_commitment(self, hotkey: Hotkey) -> GetCommitmentResponse:  # type: ignore[reportIncompatibleMethodOverride]
        """
    ...
    async def get_own_commitment(self) -> GetCommitmentResponse:  # type: ignore[reportIncompatibleMethodOverride]
        """
    ...
    async def _put_weights_request(self, weights: dict[Hotkey, Weight]) -> SetWeightsRequest:  # type: ignore[reportIncompatibleMethodOverride]
    ...
    async def _get_own_commitment_request(self) -> GetOwnCommitmentRequest:  # type: ignore[reportIncompatibleMethodOverride]
